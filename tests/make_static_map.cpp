...
static_assert(make_static_map(1,2,3,4,5,6).at(2) == std::nullopt);
static_assert(make_static_map(1,2,3,4,5,6).at(3) == 4);
static_assert(make_static_map(1,2,3,4,5,6)[1] == 2);
//static_assert(make_static_map(1,2,3,4,5,6)[2]);
...
static_assert(make_static_map("One"sv,1,"Two"sv,2,"Three"sv,3).at("Zero") == std::nullopt);
static_assert(make_static_map("One"sv,1,"Two"sv,2,"Three"sv,3)["One"] == 1);
//static_assert(make_static_map("One"sv,1,"Two"sv,2,"Three"sv,3)["Zero"]);
